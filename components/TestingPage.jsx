              ...
              <video
                ...
                className={styles.cameraDisplay +
                  ...
                  currentAction === "useScanHealthcareCard"
                    ...
                    : styles.mirrored) +
                  " " +
                  (showSuccess ? styles.cameraDisplaySuccess : "") +
                  " " +
                  (iOS() ? styles.cameraObjectFitFill : "")
                }
                muted
                autoPlay
                playsInline
            ...
            <div>
              ...
              <label>
                <input
                  ...
                  style={{ display: "none" }}
                />
                <span className={styles.button}>Cropped Document Image</span>
              </label>
              <label>
                <input
                  type="file"
                  ...
                  style={{ display: "none" }}
                />
                <span className={styles.button}>Face Image</span>
              </label>

              <button className={styles.button} onClick={handleDocumentMugshotFaceCompare}>
                Do Compare
              </button>
              ...
              {/* {/* <label>
                <input
                  ...
                  style={{ display: "none" }}
                />
                <span className={styles.button}>Upload Back Dl Test</span>
              </label> 
            ...
            */}
              <label>
                <input
                  ...
                  style={{ display: "none" }}
                />
                <span className={styles.button}>UPLOAD FACEt</span>
              </label>

              <button className={styles.button} onClick={handlePredictWithImage}>Predict Face Uploaded</button>
            </div>
          </div>
        </div>
      ) : !deviceSupported.isChecking && !deviceSupported.supported ? (
